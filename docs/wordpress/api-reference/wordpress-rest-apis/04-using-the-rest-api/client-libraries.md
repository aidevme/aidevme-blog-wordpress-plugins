...
Reference: <https://developer.wordpress.org/rest-api/using-the-rest-api/client-libraries/>
...
To perform authenticated requests from outside of the WordPress admin, themes, or plugins, a separate
