...
Reference: <https://developer.wordpress.org/rest-api/using-the-rest-api/global-parameters/>
...
preflight requests for cross-domain requests, but JSONP can be used to ensure support with all browsers.
