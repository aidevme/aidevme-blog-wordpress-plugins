...
The 3 basic hooks you'll need when creating a plugin are `register_activation_hook()`, `register_deactivation_hook()`, and `register_uninstall_hook()`.
