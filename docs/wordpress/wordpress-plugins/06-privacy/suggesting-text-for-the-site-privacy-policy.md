...
> Supplemental information can be provided through the use of the specialized
> 
> .privacy-policy-tutorial
> 
> CSS class. Any content contained within HTML elements that have this CSS class applied will be omitted from the clipboard when the section content is copied.
