...
> Note there are no submit buttons in meta boxes.
> 
> The meta box HTML is included inside the edit screen's form tags, all the post data including meta box values are transfered via
> 
> POST
> 
> when the user clicks on the Publish or Update buttons.
...
> 
> Available only in the WordPress Administration.
> 
> Make sure it is not empty before performing any logic.
